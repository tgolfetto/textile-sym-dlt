...
public class WasteResponseContract implements Contract {

    public static final String WasteResponseContract_ID = "it.polimi.tgolfetto.textile-sym-dlt.contracts.WasteResponseContract";
    ...
    public void verifyMembershipsForWasteResponseTransaction(LedgerTransaction tx, String networkId,
        ...
        requireThat(require -> {
            ...
            require.using("Municipality should have business identity of FirmIdentity type",
                    receiverMembership.getIdentity().getBusinessIdentity().getClass().equals(MunicipalityIdentity.class));
            return null;
        });
    }
