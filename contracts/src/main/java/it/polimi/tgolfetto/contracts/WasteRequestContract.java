...
public class WasteRequestContract implements Contract {

    public static final String WasteRequestContract_ID = "it.polimi.tgolfetto.textile-sym-dlt.contracts.WasteRequestContract";
